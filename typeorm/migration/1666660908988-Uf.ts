...
export class Uf1666660908988 implements MigrationInterface {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          charColumn({ name: 'uf', length: '2' }),
          intColumn({ name: 'ibge' }),
          varcharColumn({ name: 'ddd', length: '30', isNullable: true }),
        ],
      }),
    );

    await queryRunner.query(`
      INSERT INTO Uf (id, name, uf, ibge, ddd) 
        VALUES
        (1, 'Acre', 'AC', 12,'68'),
        (2, 'Alagoas', 'AL', 27,'82'),
